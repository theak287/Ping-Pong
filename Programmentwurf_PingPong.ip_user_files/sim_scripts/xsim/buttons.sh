...
#
# Script generated by Vivado on Mon Nov 17 18:04:23 +0100 2025
...
#
# Usage        : buttons.sh
#                buttons.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                buttons.sh [-reset_run]
#                buttons.sh [-reset_log]
#                buttons.sh [-help]
#
...
# script info
echo -e "buttons.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./buttons.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot buttons xil_defaultlib.buttons xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim buttons -key {Behavioral:sim_1:Functional:buttons} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb buttons.wdb xsim.dir libdpi.so)
...
Usage: buttons.sh [-step]\n\
Usage: buttons.sh [-lib_map_path]\n\
Usage: buttons.sh [-reset_run]\n\
Usage: buttons.sh [-reset_log]\n\
Usage: buttons.sh [-keep_index]\n\
